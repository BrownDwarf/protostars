...
class ThetaParam(ThetaParamBase):
    ...
    '''
    def __init__(self, grid, vz=0.0, vsini=0.0, logOmega=0.0, Av=0.0, T_BB=1100.0, logOmega2=0.0, exponentAv=-2.0):
        ThetaParamBase.__init__(self, grid, vz, vsini, logOmega, Av, T_BB, logOmega2)
        self.exponentAv = exponentAv

    def __repr__(self):
        return "grid:{} vz:{} vsini:{} logOmega:{} Av:{} T_BB:{} logOmega2:{} exponentAv:{}".format(self.grid,
         self.vz, self.vsini, self.logOmega, self.Av, self.T_BB, self.logOmega2, self.exponentAv)